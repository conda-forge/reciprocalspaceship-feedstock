...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/reciprocalspaceship-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/reciprocalspaceship-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add reciprocalspaceship
# for installing globally
pixi global install reciprocalspaceship
```
...
It is possible to list all of the versions of `reciprocalspaceship` available on your platform:
...
```
pixi search reciprocalspaceship --channel conda-forge
```
